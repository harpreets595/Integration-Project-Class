    ...
    public class BikesController : Controller
    {
        ...
        */
        ...
        public IActionResult Road()
        {
            ...
            return View(validRoadProducts.ToList());
        }
        ...
        public IActionResult Mountain()
        {
            ...
            return View(validMountainProducts.ToList());
        }
        ...
        public IActionResult Touring()
        {
            ...
            return View(validTouringProducts.ToList());
        }
        ...
        public async Task<IActionResult> Details(int? id)
        {
            ...
            var product = (from bikes in db.Product
                           where bikes.ProductModelId == id &&
                           bikes.SellEndDate == null
                           select bikes);
